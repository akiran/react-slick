...
export const safePreventDefault = event => {
  var passiveEvents = event._reactName? ["onTouchStart", "onTouchMove", "onWheel"] : ['touchstart', 'touchmove', 'wheel'];
  const eventName = event._reactName ? event._reactName : event.type
