...
var EventHandlers = {
  ...
  swipeMove: function (e) {
    ...
    positionOffset = (this.props.settings.rtl === false ? 1 : -1) * (touchObject.curX > touchObject.startX ? 1 : -1);
  ...
  swipeEnd: function (e) {
    var minSwipe = this.state.listWidth/this.props.settings.touchThreshold;
