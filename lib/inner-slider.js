...
var InnerSlider = (exports.InnerSlider = (function(_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _this.normalizeSlideIndex = function(index) {
      if (index < 0) {
        return index + _this.state.slideCount;
      }

      if (index > _this.state.slideCount - 1) {
        return index - _this.state.slideCount;
      }
    ...
    _this.onDemandLazyLoad = function() {
      var slidesToLoad = [];
      ...
      var candidatesToBeLazyLoaded = [
        currentSlide,
        _this.normalizeSlideIndex(currentSlide + 1),
        _this.normalizeSlideIndex(currentSlide + 2),
        _this.normalizeSlideIndex(currentSlide - 1),
        _this.normalizeSlideIndex(currentSlide - 2)
      ];
      candidatesToBeLazyLoaded.forEach(function(index) {
