...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventHandlers = {
	  ...
	  getSlideCount: function getSlideCount() {
	    ...
	    var centerOffset = this.props.centerMode === true ? this.state.slideWidth * Math.floor(this.props.slidesToShow / 2) : 0;

	    if (this.props.swipeToSlide === true) {
	      ...
	      Array.from(slides).every(function (slide, index) {
	        if (slide.offsetLeft - centerOffset + _helpers2.default.getWidth(slide) / 2 > _this.state.swipeLeft * -1) {
	          swipedSlide = slide;
	          return false;
	        }
